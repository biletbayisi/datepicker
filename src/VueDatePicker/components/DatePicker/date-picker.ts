...
import type { ICalendarDate, ICalendarDay, WeekStartNum, IMarker, VueEmit } from '@/interfaces';
...
export const useDatePicker = (
    ...
    const { defaultedMultiCalendars, defaultedRange, defaultedTz, propDates } = useDefaults(props);
